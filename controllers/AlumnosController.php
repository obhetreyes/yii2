    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('create', [
                'model' => $model, 'carreras' => \app\models\Carreras::getAll(),'docentes' => \app\models\Docentes::getAll(),'grupos' => \app\models\Grupos::getAll(),'sesiones' => \app\models\Sesiones::getAll(),
            ]);
        }
    }
